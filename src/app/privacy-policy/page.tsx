...
export default function PrivacyPolicyPage() {
  return (
    <Main>
      <PageHeader title='Privacy Policy' description='プライバシーポリシー' />
        ...
        <div className='mx-auto max-w-3xl space-y-12'>
          ...
          <section className='space-y-6'>
            ...
            <div className='space-y-4'>
              ...
              <ol className='list-decimal space-y-2 pl-5 text-sm leading-loose tracking-wide'>
          ...
          <section className='space-y-6'>
            <h2 className='font-bold text-heading text-lg'>7. 第三者提供</h2>
            <div className='space-y-4'>
              <p className='text-sm leading-loose tracking-wide'>
          ...
          <section className='space-y-6'>
            ...
            <p className='text-sm leading-loose tracking-wide'>
              当ショップではセキュリティ確保のため、個人情報が傍受、妨害または改ざんされることを防ぐ目的でSSL（Secure
          ...
          <section className='space-y-6'>
            <h2 className='font-bold text-heading text-lg'>13. お問い合わせ</h2>
            <p className='text-sm leading-loose tracking-wide'>
          ...
          <section className='space-y-6'>
            <h2 className='font-bold text-heading text-lg'>14. 継続的改善</h2>
            <p className='text-sm leading-loose tracking-wide'>
